    ...
    public static void main(String[] args) throws IOException, ExecutionException, InterruptedException {
        ...
        while (currentAttempt < maxAttempts) {
            ...
            if(result.isPresent()) {
                ...
                if(answer.isPresent()) {
                    Utils.writeMessage(socketChannel, Constants.G_FUNCTION_NAME + "=" + answer.get());
                } else {
                    Utils.writeMessage(socketChannel, "HardFail " + Constants.G_FUNCTION_NAME);
                }
                return;
            }
            Utils.writeMessage(socketChannel, "SoftFail " + Constants.G_FUNCTION_NAME
